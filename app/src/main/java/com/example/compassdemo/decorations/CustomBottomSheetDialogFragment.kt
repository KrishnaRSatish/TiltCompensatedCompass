...
open class CustomBottomSheetDialogFragment : BottomSheetDialogFragment(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onResume() {
        super.onResume()
        com.example.compassdemo.prefrences.SharedPreferences.getSharedPreferences().registerOnSharedPreferenceChangeListener(this)
    }

    override fun onDestroy() {
        super.onDestroy()
        com.example.compassdemo.prefrences.SharedPreferences.getSharedPreferences().unregisterOnSharedPreferenceChangeListener(this)
    }
