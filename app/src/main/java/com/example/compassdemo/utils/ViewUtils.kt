package com.example.compassdemo.utils
...
object ViewUtils {
    ...
    fun addShadow(contentView: View) {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.P) {
            contentView.outlineAmbientShadowColor = contentView.context.getColor(R.color.colorAccent)
            contentView.outlineSpotShadowColor = contentView.context.getColor(R.color.colorAccent)
        }
    }
